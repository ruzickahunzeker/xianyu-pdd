...
export interface ProductMaterialSKU { material_sku_id?:string; source_goods_id?:string; source_sku_id?:string; source_properties?:Array<{name:string;value:string}>; source_image_url?:string; source_price_cent?:number; source_normal_price_cent?:number; source_price_updated_at?:number; source_price_origin?:'collected'|'synced'|'backfilled_current'; price_cent:number; quantity:number; enabled:boolean; image_url?:string; properties:Array<{name:string;value:string;image_url?:string}> }
