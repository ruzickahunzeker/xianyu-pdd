...
ALTER TABLE product_materials ADD COLUMN split_batch_id VARCHAR(64) NOT NULL DEFAULT '';
ALTER TABLE product_materials ADD COLUMN split_group_name VARCHAR(191) NOT NULL DEFAULT '';
ALTER TABLE product_materials ADD COLUMN is_split_source TINYINT NOT NULL DEFAULT 0;
CREATE INDEX idx_product_materials_parent ON product_materials(user_id,parent_material_id,deleted_at);

-- +goose Down
DROP INDEX idx_product_materials_parent ON product_materials;
