-- +goose Up
ALTER TABLE order_fulfillments ADD COLUMN fulfillment_exempt TINYINT NOT NULL DEFAULT 0;
ALTER TABLE order_fulfillments ADD COLUMN reminder_exempt TINYINT NOT NULL DEFAULT 0;
ALTER TABLE order_fulfillments ADD COLUMN manual_modified_at BIGINT NOT NULL DEFAULT 0;
ALTER TABLE order_fulfillments ADD COLUMN manual_modified_fields TEXT NOT NULL DEFAULT '';
ALTER TABLE order_fulfillments ADD COLUMN history_repaired_at BIGINT NOT NULL DEFAULT 0;
