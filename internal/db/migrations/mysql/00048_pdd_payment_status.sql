-- +goose Up
ALTER TABLE order_fulfillments ADD COLUMN pdd_paid TINYINT NOT NULL DEFAULT 0;
ALTER TABLE order_fulfillments ADD COLUMN pdd_paid_at BIGINT NOT NULL DEFAULT 0;
ALTER TABLE order_fulfillments ADD COLUMN pdd_paid_source VARCHAR(64) NOT NULL DEFAULT '';
...
-- +goose Down
DROP INDEX idx_order_fulfillments_paid ON order_fulfillments;
