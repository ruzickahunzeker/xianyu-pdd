...
func (s *Server) mountFulfillment(r chi.Router) {
	...
	r.Get("/api/fulfillment/logistics-sync-tasks", s.listLogisticsSyncTasks)
	r.Post("/api/fulfillment/orders/{order_id}/logistics-sync", s.queueLogisticsSync)
	r.Post("/api/fulfillment/logistics-sync/batch", s.queueLogisticsSyncBatch)
	r.Post("/api/fulfillment/logistics-sync-tasks/claim", s.claimLogisticsSyncTask)
	r.Post("/api/fulfillment/logistics-sync-tasks/{task_id}/heartbeat", s.heartbeatLogisticsSyncTask)
	r.Post("/api/fulfillment/logistics-sync-tasks/{task_id}/result", s.completeLogisticsSyncTask)
